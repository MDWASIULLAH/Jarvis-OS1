...
from app.capabilities.vision_ocr import extract_text_from_image, ocr_available


@pytest.mark.skipif(not ocr_available(), reason="Tesseract OCR binary is not installed in this environment.")
